function z_unit_vector = quaternion2z(quaternion)
    % Input: quaternion = [q0, q1, q2, q3] (scalar part + vector part)
    % Output: z_unit_vector = [x, y, z] (unit vector representing the Z-axis direction)
    ...
    % Extract the third column of the rotation matrix (Z-axis direction)
    z_unit_vector = R(:, 3);
end
