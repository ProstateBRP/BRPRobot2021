classdef Robot < Kinematics
    ...
    methods
        ...
        function obj = startup(obj)
            ...
            obj.Time_SimEnd = 1000 / obj.Stabbing_Vel;
            ...
            obj.Needle_pose_act = obj.Needle_pose_ini;
        ...
        %% ===================================================================
        function obj = reachable(obj, target)
        ...
        %% ===================================================================
        function reach = move_to_end(obj)
            %MOVE_TO_END Main insertion function for open loop control
            obj.flag_terminate_z = 0;
            obj.flag_terminated = 0;
            sim_time = tic;
