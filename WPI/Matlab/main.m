        ...
        case "START_UP"
            ...
            while robot_not_ready
                ...
                if robot_not_ready
                    ...
                    status = struct('code', 1, 'subCode', 1, 'errorName', 'none', 'message', 'START_UP');
                    idle_flag = true;
                    state = "IDLE";
                    command_recieved = false;
            ...
            if ~robot_not_ready 
                ...
                while ~strcmp(robot_mode, 'calibration')
                    ...
                    if ~strcmp(robot_mode, 'calibration')
                        ...
                        status = struct('code', 1, 'subCode', 0, 'errorName', 'none', 'message', 'CALIBRATION');
                    end
                ...
                if ~fail_flag
                    ...
                    while ~calibration_finsh_flag
                        ...
                        elseif strcmpi(type, 'TRANSFORM')
                            server.sender.WriteOpenIGTLinkStringMessage(char("ACK_"+id(2)), char(type));
